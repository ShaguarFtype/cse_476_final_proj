...
#SBATCH --output=training/logs/reasoning_%j.log
#SBATCH --error=training/logs/reasoning_%j.err
...
# Run training script
python training/train.py --config training/configs/reasoning_config.yaml 