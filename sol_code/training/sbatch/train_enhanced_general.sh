...
#SBATCH --output=training/logs/enhanced_general_%j.log
#SBATCH --error=training/logs/enhanced_general_%j.err
...
python training/train_enhanced.py --config training/configs/enhanced_general_config.yaml