...
#SBATCH --output=training/logs/enhanced_reasoning_%j.log
#SBATCH --error=training/logs/enhanced_reasoning_%j.err
...
python training/train_enhanced.py --config training/configs/enhanced_reasoning_config.yaml